...
void core::DamageProbabilityTable::fillTankTableWithoutFile()
{
	m_damageProbabilities[ThreatLevel{ 0 }] = std::vector{
		 ...
		 Probability{tank_state_system::kCommanderKilled, 3}, Probability{tank_state_system::kLoaderKilled, 1}, Probability{tank_state_system::kGunnerKilled, 3}, Probability{tank_state_system::kChargerKilled, 2},
	...
	m_damageProbabilities[ThreatLevel{ -3 }] = std::vector{
		 ...
		 Probability{tank_state_system::kCommanderKilled, 2}, Probability{tank_state_system::kLoaderKilled, 0}, Probability{tank_state_system::kGunnerKilled, 1}, Probability{tank_state_system::kChargerKilled, 1},
	...
	m_damageProbabilities[ThreatLevel{ -2 }] = std::vector{
		 ...
		 Probability{tank_state_system::kCommanderKilled, 2}, Probability{tank_state_system::kLoaderKilled, 0}, Probability{tank_state_system::kGunnerKilled, 2}, Probability{tank_state_system::kChargerKilled, 2},
	...
	m_damageProbabilities[ThreatLevel{ -1 }] = std::vector{
		 ...
		 Probability{tank_state_system::kCommanderKilled, 3}, Probability{tank_state_system::kLoaderKilled, 1}, Probability{tank_state_system::kGunnerKilled, 2}, Probability{tank_state_system::kChargerKilled, 2},
	...
	m_damageProbabilities[ThreatLevel{ 1 }] = std::vector{
		 ...
		 Probability{tank_state_system::kCommanderKilled, 4}, Probability{tank_state_system::kLoaderKilled, 2}, Probability{tank_state_system::kGunnerKilled, 3}, Probability{tank_state_system::kChargerKilled, 2},
	...
	m_damageProbabilities[ThreatLevel{ 3 }] = std::vector{
		 ...
		 Probability{tank_state_system::kCommanderKilled, 5}, Probability{tank_state_system::kLoaderKilled, 3}, Probability{tank_state_system::kGunnerKilled, 3}, Probability{tank_state_system::kChargerKilled, 2},
